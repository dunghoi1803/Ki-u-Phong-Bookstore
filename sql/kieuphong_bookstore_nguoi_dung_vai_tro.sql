...
CREATE TABLE `nguoi_dung_vai_tro` (
  ...
  KEY `fk_ndvt_vt` (`ma_vai_tro`),
  CONSTRAINT `fk_ndvt_nd` FOREIGN KEY (`ma_nguoi_dung`) REFERENCES `nguoi_dung` (`ma_nguoi_dung`),
  CONSTRAINT `fk_ndvt_vt` FOREIGN KEY (`ma_vai_tro`) REFERENCES `vai_tro` (`ma_vai_tro`)
...
INSERT INTO `nguoi_dung_vai_tro` VALUES (1,1),(2,1),(2,2);
