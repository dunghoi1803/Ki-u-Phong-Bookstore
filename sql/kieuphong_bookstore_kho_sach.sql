...
CREATE TABLE `kho_sach` (
  ...
  `nguong_thap_toi_thieu` int NOT NULL DEFAULT '3',
  `ngay_cap_nhat` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`ma_sach`),
  CONSTRAINT `fk_kho_sach` FOREIGN KEY (`ma_sach`) REFERENCES `sach` (`ma_sach`) ON DELETE CASCADE
...
INSERT INTO `kho_sach` VALUES (1,119,0,3,'2025-11-18 10:56:35'),(2,200,0,3,'2025-11-18 02:58:15'),(3,80,0,3,'2025-11-18 02:58:15'),(4,90,0,3,'2025-11-18 02:58:15'),(5,144,0,3,'2025-11-18 10:56:33'),(6,70,0,3,'2025-11-18 02:58:15'),(7,140,0,3,'2025-11-18 02:58:15'),(8,109,0,3,'2025-11-18 10:56:35'),(9,50,0,3,'2025-11-18 10:50:38');
