...
CREATE TABLE `the_loai` (
  ...
  `ten_the_loai` varchar(191) NOT NULL,
  `ma_the_loai_cha` int DEFAULT NULL,
  PRIMARY KEY (`ma_the_loai`),
  KEY `fk_tl_tlcha` (`ma_the_loai_cha`),
  CONSTRAINT `fk_tl_tlcha` FOREIGN KEY (`ma_the_loai_cha`) REFERENCES `the_loai` (`ma_the_loai`)
...
INSERT INTO `the_loai` VALUES (1,'Kinh tế học',NULL),(2,'Tâm lý học',NULL),(3,'Tiểu thuyết - Văn học',NULL),(4,'Thiếu nhi',NULL),(5,'Trinh thám',NULL),(6,'Khoa học hành vi',2),(7,'Kỹ năng sống',1);
