...
CREATE TABLE `vai_tro` (
  ...
  `ma_vai_tro_code` varchar(64) NOT NULL,
  `ten_vai_tro` varchar(128) NOT NULL,
  PRIMARY KEY (`ma_vai_tro`),
  UNIQUE KEY `ma_vai_tro_code` (`ma_vai_tro_code`)
...
INSERT INTO `vai_tro` VALUES (1,'customer','Khach hang'),(2,'admin','Admin');
...
-- Dump completed on 2025-11-18 19:44:53
