...
CREATE TABLE `sach_the_loai` (
  ...
  KEY `fk_stl_tl` (`ma_the_loai`),
  CONSTRAINT `fk_stl_sach` FOREIGN KEY (`ma_sach`) REFERENCES `sach` (`ma_sach`) ON DELETE CASCADE,
  CONSTRAINT `fk_stl_tl` FOREIGN KEY (`ma_the_loai`) REFERENCES `the_loai` (`ma_the_loai`)
...
INSERT INTO `sach_the_loai` VALUES (4,2),(2,3),(3,3),(5,4),(8,4),(9,4),(6,5),(1,6),(7,7);
